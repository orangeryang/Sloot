...
function renderWithColors(items: string[]) {
    ...
    let result = "<svg xmlns=\"http://www.w3.org/2000/svg\" preserveAspectRatio=\"xMinYMin meet\" viewBox=\"0 0 660 350\">    <style>        .base {            fill: white;            font-family: serif;            font-size: 13px;        }        .green {            fill: green;            font-family: serif;            font-size: 13px;        }        .blue {            fill: blue;            font-family: serif;            font-size: 13px;        }        .purple {            fill: purple;            font-family: serFif;            font-size: 13px;        }        .orange {            fill: orange;            font-family: serif;            font-size: 13px;        }    </style>    <rect width=\"100%\" height=\"100%\" fill=\"black\" />";
